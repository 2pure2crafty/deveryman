...
$conductorUrl = fw_config_get('EVERYMAN_CONDUCTOR_URL');
$dpaUrl       = fw_config_get('EVERYMAN_DPA_URL');
...
$registryPath = '/var/www/everyman/conductor/registry.json';
$projects = [];
